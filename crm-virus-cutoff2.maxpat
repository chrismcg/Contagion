	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "thispatcher",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 391.0, 333.0, 69.0, 20.0 ],
					"id" : "obj-24",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "offset $1 0",
					"outlettype" : [ "" ],
					"patching_rect" : [ 446.0, 256.0, 66.0, 18.0 ],
					"id" : "obj-23",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "* -50",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 442.0, 212.0, 36.0, 20.0 ],
					"id" : "obj-21",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "== 0",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 275.0, 118.0, 35.0, 20.0 ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "active $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.0, 160.0, 59.0, 18.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 417.0, 103.0, 20.0, 20.0 ],
					"id" : "obj-16",
					"numinlets" : 1,
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "active $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 158.0, 59.0, 18.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 282.0, 61.0, 25.0, 25.0 ],
					"id" : "obj-12",
					"numinlets" : 0,
					"numoutlets" : 1,
					"comment" : ""
...
, 			{
				"box" : 				{
					...
					"text" : "+ 64",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 89.0, 290.0, 34.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 98.0, 386.0, 138.0, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial Bold",
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 92.0, 172.0, 18.0 ],
					"id" : "obj-9",
					"fontname" : "Arial Bold",
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "#2 #1 $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 342.0, 49.0, 16.0 ],
					"id" : "obj-4",
					"fontname" : "Arial Bold",
					"numinlets" : 2,
					"numoutlets" : 1,
